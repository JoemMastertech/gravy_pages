const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-o0JHZoss.js","assets/index-SV0FPQTz.css","assets/AuthService-BfxwfPB8.js"])))=>i.map(i=>d[i]);
import{_ as h,L,g as $,A as m,e as _}from"./index-o0JHZoss.js";import y from"./SidebarManager-BcOD6Mmh.js";class g{constructor(i){this.config=i,this.container=document.createElement("div"),this.container.className="media-uploader",this.render()}render(){const{type:i,initialUrl:s}=this.config,a=i==="image"?"image/webp":"video/webm,image/webp",t=i==="image"?"Imagen (WebP)":"Video (WebM)",n="https://convertio.co/es/";this.container.innerHTML=`
